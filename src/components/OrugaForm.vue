    ...
    <o-steps v-model="currentStep" stepContentClass="o-demo-form">
      <o-step-item step="1" label="Profile">
        ...
        <o-field :message="messages.name" :variant="messages.name ? 'danger' : ''">
          ...
          <o-input id="name" type="text" placeholder="Name" v-model="name" expanded />
        </o-field>
      ...
      <o-step-item step="2" label="Account">
        ...
        >
          <o-input v-model="username" id="username" type="text" placeholder="Username" expanded />
        </o-field>
        <o-field
          label="Password"
          label-for="password"
      ...
      <o-step-item label="Finish" step="3">
        ...
        <div class="o-demo-form__activate-button-wrapper">
          <o-button outlined variant="primary" @click="activateAccount">Click to activate account</o-button>
        </div>
