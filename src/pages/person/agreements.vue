...
<template>
  <form @submit.prevent="save" class="flex-1 lg:col-span-9">
    <SectionWrapper>
      <SectionHeader>{{ t('mother_agreements') }}</SectionHeader>

      <fieldset class="mt-8">{{ t('no_agreement_signatures_found') }}</fieldset>
